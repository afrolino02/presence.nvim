...
return {
    ...
    ["ts.component"] = { "Angular component TypeScript", "https://i.ibb.co/jDvq1mV/angular-svgrepo-com.png" }, 
    ...
    scala = { "Scala", "scala" },
    scm = { "Scheme", "scheme" },
    scss = { "Sass", "https://w7.pngwing.com/pngs/206/645/png-transparent-sass-logos-and-brands-line-filled-icon.png" },
